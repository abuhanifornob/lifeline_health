        ...
        <section className="text-gray-600 body-font relative">
          <form action="https://formsubmit.co/itinfobd24@gmail.com" method="post">
            <div className="container px-5  mx-auto flex sm:flex-nowrap flex-wrap">
              <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative" data-aos="fade-left"
                data-aos-offset="500">
                <iframe
                  width="100%"
                  height="100%"
                ...
                <div className="bg-white relative flex p-3 flex-wrap py-6 rounded shadow-md">
              ...
              <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0" data-aos="fade-right"
                data-aos-offset="500">
