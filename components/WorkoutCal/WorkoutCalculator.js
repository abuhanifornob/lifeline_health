...
const WorkoutCalculator = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-3xl font-semibold mb-4">Gym Workout Calculator</h1>
...
<option value="lightlyActive">Lightly Active (light exercise/sports 1-3 days per week)</option>
...

    {
        feedback && (
            <div className="mt-8 text-center">
                ...
                <p className="text-3xl text-blue-500 font-bold">{feedback}</p>
