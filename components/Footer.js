...
const Footer = () => {
    return (
        <footer className="text-gray-600 body-font max-w-screen-xl mx-auto ">
        <div className="container px-5  mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <Link className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900" href={"/"}>
              <Image src={logo} height={300} width={200} />
            </Link>
        ...
        <div className="bg-[#4791ff]">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="font-medium text-xl text-[#254747] text-center sm:text-left">© 2023 Redmoon Warriar
              <Link href="/" rel="noopener noreferrer" className="text-[#254747] ml-1" target="_blank">@Readmon</Link>
            </p>
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
              <Link href={"/"} className="text-[#254747] text-xl">
                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                </svg>
              </Link>
              <Link href={"/"} className="ml-3 text-[#254747] text-xl">
                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
